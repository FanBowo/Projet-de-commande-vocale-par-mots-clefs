...
HOP_LENGTH=256 #Nombre d'échantillons entre deux trames successives
...
HEIGHT_CONV1=3	#Longueur du filtre de la première couche
WIDTH_CONV1=3	#Largeur du filtre de la première couche

NUM_CONV2=30	#Profondeur de la deuxième couche de convolution = Nombre des kernels de convolution de la deuxième couche
HEIGHT_CONV2=3	#Longueur du filtre de la deuxième couche
WIDTH_CONV2=3	#Largeur du filtre de la deuxième couche

NUM_CONV3=60	#Profondeur de la triusième couche de convolution = Nombre des kernels de convolution de la troisième couche
HEIGHT_CONV3=3	#Longueur du filtre de la troisième couche
WIDTH_CONV3=3	#Largeur du filtre de la troisième couche

NUM_CONV4=80	#Profondeur de la quatième couche de convolution = Nombre des kernels de convolution de la troisième couche
HEIGHT_CONV4=3	#Longueur du filtre de la quatième couche
WIDTH_CONV4=3	#Largeur du filtre de la quatième couche

NUM_CONV5=120	#Profondeur de la cinqième couche de convolution = Nombre des kernels de convolution de la troisième couche
HEIGHT_CONV5=3	#Longueur du filtre de la cinqième couche
WIDTH_CONV5=3	#Largeur du filtre de la cinqième couche

POOL_HEIGHT=2	#longueur de la couche de Pooling 
POOL_WIDTH=2	#Largeur de la couche de Pooling

EPOCH=20		#Nombre de répétitions d'apprentissage
...
SIZE_AFTER_CONV3_POOL=[math.floor(SIZE_AFTER_CONV3[0]/POOL_HEIGHT),\
                       math.floor(SIZE_AFTER_CONV3[1]/POOL_WIDTH)]
SIZE_AFTER_CONV4=[math.floor(SIZE_AFTER_CONV3_POOL[0]+1-HEIGHT_CONV4),\
                  math.floor(SIZE_AFTER_CONV3_POOL[1]+1-WIDTH_CONV4)]
SIZE_AFTER_CONV5=[math.floor(SIZE_AFTER_CONV4[0]+1-HEIGHT_CONV5),\
                  math.floor(SIZE_AFTER_CONV4[1]+1-WIDTH_CONV5)]
#%% Nombre d'éléments pour la première couche linéaire
NUM_ELEMENT_FIRST_LAYER_LINEAR=NUM_CONV5 * SIZE_AFTER_CONV5[0] *SIZE_AFTER_CONV5[1]
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(NUM_CONV3, NUM_CONV4, [HEIGHT_CONV4,WIDTH_CONV4])
        self.conv5 = nn.Conv2d(NUM_CONV4, NUM_CONV5, [HEIGHT_CONV5,WIDTH_CONV5])
        self.fc1 = nn.Linear(NUM_ELEMENT_FIRST_LAYER_LINEAR, 1000)
        self.fc2 = nn.Linear(1000, 100)
        self.fc3 = nn.Linear(100, 50)
        self.fc4 = nn.Linear(50, NUM_CAT)
    ...
    def forward(self, x):
        ...
        #tranfére des data au vecteur
        #ci dessous: couches de linéralisation
        x = x.view(-1, NUM_ELEMENT_FIRST_LAYER_LINEAR)
        x = F.relu(self.fc1(x))
        x = F.relu(self.fc2(x))
        x = F.relu(self.fc3(x))
        x = self.fc4(x)
...
#                  (epoch + 1, i + 1, running_loss / 20))
            runningloss.append(running_loss / 20)
            running_loss = 0.0
