...
N_MFCC=32 #Nombre de features MFCC
PROP_NOISE=0.2	#Proportion du bruit à ajouter aux enregistrements	 
...
EPOCH=15		#Nombre de répétitions d'apprentissage
...
#%%
#Dimensions du spectrogramme après l'extraction des features de MFCC
...
NUM_ELEMENT_FIRST_LAYER_LINEAR=NUM_CONV3 * SIZE_AFTER_CONV3_POOL[0] *SIZE_AFTER_CONV3_POOL[1]
